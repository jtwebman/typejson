...
All values in TypeJSON have a type. They include some basic types already support by JSON like string, boolean, and number (float). Notice null, object, and array are not types. We will talk about them later.
